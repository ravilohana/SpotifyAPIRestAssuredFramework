...
public class SpotifyPlayListAPI_TestCases_Using_POJO_Builder_Pattern {
    ...
    public void shouldBeAbleToCreateAPlaylist_pojo() {
        ...
        SpotifyPlayList req_spotifyPlayList = new SpotifyPlayList()
                .setName("Spotify PlayList POJO 2")
                .setDescription("Spotify playlist created by rest assured using POJO 2")
                .setPublic(false);
    ...
    public void shouldBeAbleToGetAPlaylist_pojo() {
        ...
        SpotifyPlayList req_spotifyPlayList = new SpotifyPlayList()
                .setName("Rest Assured Spotify PL 0002")
                .setDescription("Spotify playlist created by Spotify web api using Rest Assured")
                .setPublic(false);
    ...
    public void shouldBeAbleToUpdateAPlaylist_pojo() {
        ...
        SpotifyPlayList req_spotifyPlayList = new SpotifyPlayList()
                .setName("Rest Assured Spotify PL 0002-updated")
                .setDescription("Spotify playlist created by Spotify web api using Rest Assured-updated")
                .setPublic(false);
